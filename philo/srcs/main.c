...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/26 21:47:02 by agiraud           #+#    #+#             */
/*   Updated: 2022/03/26 21:50:39 by agiraud          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/philo.h"

//On met les arguments dans la structure data

t_data	parse_arg(int argc, char **argv)
{
	t_data	data;
...
//Met en pause le philosphe le temps qu'il dorme ou qu'il mange
...
//Fonction qui permet les changements d'etats d'un philosophe
...
//fonction principal qui gere les philos
...
int	philo(t_data data)
{
	...
	while (i < data.num_of_philo)
	{
		...
		pthread_create(&philos[i].p, NULL, life, &(philos[i]));
		usleep(100);
		i++;
	}
	i = 0;
	ft_life_eat(philos, &data);
	while (i < data.num_of_philo)
	{
